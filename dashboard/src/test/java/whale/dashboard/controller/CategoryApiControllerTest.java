...
public class CategoryApiControllerTest extends BaseControllerTest {
  ...
  void registerCategory() throws Exception {
      ...
      CategoryDto.RegistrationRequest request = new CategoryDto.RegistrationRequest("Test Subject", "Test Description");
    ...
    void modifyCategory() throws Exception {
        CategoryDto.ModifyRequest request = new CategoryDto.ModifyRequest(1L, "Modified Subject", "Modified Description", 2L);
